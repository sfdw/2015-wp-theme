...
class EF_Activation_License_Menu {
    ...
    public function add_menu() {
        ...
        $page = add_menu_page(__('Theme Activation', $ef_activation_license_manager->text_domain), __('Theme Activation', $ef_activation_license_manager->text_domain), 'edit_theme_options', 'ef-activation', array($this, 'config_page')
        );
